...
//!
//! The transcript is an append-only event stream; the rows Tokenomics needs are:
//!
...
/// Split DSH's usage row into Tokenomics's five additive buckets.
///
...
mod tests {
    ...
    fn reasoning_tokens_do_not_inflate_the_additive_output_bucket() {
        ...
        // input + cache + output and never adds reasoning. Tokenomics's buckets
