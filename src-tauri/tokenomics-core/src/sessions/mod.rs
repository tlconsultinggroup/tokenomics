...
mod tests {
    ...
    fn nested_worktrees_of_mixed_kinds_roll_up_to_the_outermost_repo() {
        ...
        let encoded = "-tokenomics-probe-repo--git-worktrees-x--claude-worktrees-y";
        assert_eq!(
...
",
    ...
    fn workspace_path_for_key_separates_paths_from_opaque_ids() {
        ...
        assert_eq!(
            workspace_path_for_key("-nonexistent-tokenomics-probe-dir-xyz"),
            None
        );
    }
    ...
    fn decode_claude_project_slug_ignores_real_paths_and_unknown_dirs() {
        ...
        assert_eq!(
            decode_claude_project_slug("-nonexistent-tokenomics-probe-dir-xyz"),
            None
        );
    }
    ...
    fn workspace_display_label_falls_back_to_raw_key_when_undecodable() {
        ...
        let slug = "-nonexistent-tokenomics-probe-dir-xyz";
